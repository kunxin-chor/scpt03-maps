...
document.addEventListener("DOMContentLoaded", async function(){
    ...
    hdbLayerGroup.addTo(map);
     addMarkersToLayer(hdbResponse.data, hdbLayerGroup);

    const mallLayerGroup = L.layerGroup();
    addMarkersToLayer(mallResponse.data, mallLayerGroup);

    const natureLayerGroup  = L.layerGroup();
    addMarkersToLayer(natureResponse.data, natureLayerGroup);
